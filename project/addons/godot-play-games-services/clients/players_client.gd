...
enum PlayGamesFriendsListVisibilityStatus {
...
class PlayGamesPlayer:
	...
	var friends_list_visibility_status: PlayGamesFriendsListVisibilityStatus ## Visibility status of this player's friend list.
	...
	func _init(dictionary: Dictionary) -> void:
		...
		if dictionary.has("friendsListVisibilityStatus"): friends_list_visibility_status = PlayGamesFriendsListVisibilityStatus.get(dictionary.friendsListVisibilityStatus)
	...
	func _to_string() -> String:
		...
		result.append("friends_list_visibility_status: %s" % PlayGamesFriendsListVisibilityStatus.find_key(friends_list_visibility_status))
